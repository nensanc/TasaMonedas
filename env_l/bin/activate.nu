...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/lucy/Documentos/Git-Hub/TasaMonedas/env_l'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/lucy/Documentos/Git-Hub/TasaMonedas/env_l/bin/deactivate.nu'
